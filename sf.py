...
def banner():
    ...
    {cyan}  .'`---=___`===':{greenLight}   ____) | | | |  __/ | |  {yellow}| {red}Author : Tokupensx07
    {cyan} /_..---' ___.--.'{greenLight}  |_____/|_| |_|\___|_|_|  {yellow}| {red}Team   : Garuda Hacktivist
    ...
    {cyan}      `--'`._.-'  {red}GitHub : https://github.com/Tokupensx07                             
        ''')
